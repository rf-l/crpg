...
public partial class xxHash64
{
    ...
    private static unsafe ulong __inline__XXH64(byte* input, int len, ulong seed)
    {
        ...
        if (len >= 32)
        {
            ...
            do
            {
                ulong reg1 = *((ulong*)(input + 0));
                ulong reg2 = *((ulong*)(input + 8));
                ulong reg3 = *((ulong*)(input + 16));
                ulong reg4 = *((ulong*)(input + 24));
        ...
        ref ulong v4)
    {
        fixed (byte* pData = &input[0])
        {
            ...
            do
            {
                ulong reg1 = *((ulong*)(ptr + 0));
                ulong reg2 = *((ulong*)(ptr + 8));
                ulong reg3 = *((ulong*)(ptr + 16));
                ulong reg4 = *((ulong*)(ptr + 24));
